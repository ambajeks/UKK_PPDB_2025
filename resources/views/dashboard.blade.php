...
<div class="py-8">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            ...
            // Status verifikasi
            $isVerified = $form && $form->status_verifikasi == 'diverifikasi';

            // Cek revisi menunggu
            $hasRevisiMenunggu = $form && $form->hasRevisiMenunggu();
            @endphp

            {{-- Alert Revisi Menunggu --}}
            @if($hasRevisiMenunggu)
            <div class="mb-6 p-4 bg-yellow-100 border-2 border-yellow-400 rounded-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <i class="fas fa-exclamation-triangle text-yellow-600 text-xl mr-3"></i>
                        <div>
                            <h4 class="font-bold text-yellow-800">Perhatian! Ada Revisi yang Perlu Dikerjakan</h4>
                            <p class="text-yellow-700 text-sm">Admin meminta Anda untuk merevisi beberapa data.</p>
                        </div>
                    </div>
                    <a href="{{ route('revisi.index') }}"
                        class="inline-flex items-center px-4 py-2 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition duration-200 font-medium shadow">
                        <i class="fas fa-edit mr-2"></i>Kerjakan Revisi
                    </a>
                </div>
            </div>
            @endif
            ...
            <div class="mb-6">
                @if ($status === 'belum')
                <div
                    class="inline-flex items-center px-4 py-3 bg-red-100 border border-red-200 text-red-700 rounded-xl font-semibold">
                    <i class="fas fa-clock mr-2"></i>
                    Belum Mengisi Formulir
                </div>
                <div class="mt-4">
                    <a href="{{ route('formulir.index') }}"
                        class="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200 font-medium">
                ...
                @else
                <div
                    class="inline-flex items-center px-4 py-3 bg-green-100 border border-green-200 text-green-700 rounded-xl font-semibold">
                ...
                <div class="mt-4 space-y-4">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-sm text-gray-600"><strong>No. Pendaftaran:</strong>
                            {{ $form->nomor_pendaftaran ?? 'Belum ada' }}
                        </p>
                    </div>
                </div>
                @endif
            ...
            <div class="flex flex-col space-y-4">
                ...
                <div class="flex justify-between items-start">
                    ...
                    <div class="text-center flex-1">
                        <div
                            class="w-8 h-8 {{ $form ? 'bg-green-500' : 'bg-gray-400' }} rounded-full flex items-center justify-center mx-auto mb-2">
                    ...
                    <div class="text-center flex-1">
                        <div
                            class="w-8 h-8 {{ $dokumenCount > 0 ? 'bg-green-500' : 'bg-gray-400' }} rounded-full flex items-center justify-center mx-auto mb-2">
                    ...
                    <div class="text-center flex-1">
                        <div
                            class="w-8 h-8 {{ $keluargaComplete ? 'bg-green-500' : 'bg-gray-400' }} rounded-full flex items-center justify-center mx-auto mb-2">
                    ...
                    <div class="text-center flex-1">
                        <div
                            class="w-8 h-8 {{ $isPaid ? 'bg-green-500' : ($isPending ? 'bg-yellow-500' : 'bg-gray-400') }} rounded-full flex items-center justify-center mx-auto mb-2">
                            <i class="fas fa-credit-card text-white text-xs"></i>
                        </div>
                        <h3 class="font-semibold text-gray-800 text-xs mb-1">Pembayaran</h3>
                        <p
                            class="text-xs {{ $isPaid ? 'text-green-600' : ($isPending ? 'text-yellow-600' : 'text-gray-500') }}">
                            {{ $isPaid ? '✓' : ($isPending ? '...' : '✗') }}
                        </p>
                    </div>
                    ...
                    <div class="text-center flex-1">
                        <div
                            class="w-8 h-8 {{ $isVerified ? 'bg-green-500' : 'bg-gray-400' }} rounded-full flex items-center justify-center mx-auto mb-2">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="{{ route('formulir.index') }}"
                    class="p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-200 transition duration-200 text-center group">
                    <div
                        class="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-blue-600 transition duration-200">
                ...
                <a href="{{ route('dokumen.index') }}"
                    class="p-4 border border-gray-200 rounded-lg hover:bg-green-50 hover:border-green-200 transition duration-200 text-center group">
                    <div
                        class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-green-600 transition duration-200">
                ...
                <a href="{{ route('pembayaran.create') }}"
                    class="p-4 border border-gray-200 rounded-lg hover:bg-purple-50 hover:border-purple-200 transition duration-200 text-center group">
                    <div
                        class="w-10 h-10 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-3 group-hover:bg-purple-600 transition duration-200">
