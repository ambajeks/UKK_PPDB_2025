    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-8 bg-white border-b border-gray-200">
                ...
                <form method="POST" action="{{ route('formulir.store') }}" class="space-y-8">
                    @csrf
                    ...
                    <div class="border border-gray-200 rounded-lg p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="alamat" name="alamat" rows="3"
                                      ...
                                      placeholder="Masukkan alamat lengkap (jalan, RT/RW, nomor rumah)" required>{{ old('alamat', $formulir->alamat ?? '') }}</textarea>
                            @error('alamat')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
...
<div>
    ...
    @enderror
                            ...
                            <div>
                                <label for="gelombang_id" class="block text-sm font-medium text-gray-700 mb-2">
                                    Gelombang Pendaftaran <span class="text-red-500">*</span>
                                </label>
                                <select id="gelombang_id" name="gelombang_id" 
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200" required>
                                    <option value="">Pilih Gelombang</option>
                                    @foreach($gelombangs as $gelombang)
                                        <option value="{{ $gelombang->id }}" 
                                            {{ old('gelombang_id', $formulir->gelombang_id ?? '') == $gelombang->id ? 'selected' : '' }}>
                                            {{ $gelombang->nama_gelombang }} - {{ $gelombang->periode }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('gelombang_id')
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 pt-6 border-t border-gray-200">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <button type="submit" class="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200 font-medium shadow-lg">
