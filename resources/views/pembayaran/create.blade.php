...
@section('content')
        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium">Rp
                                {{ number_format($formulir->gelombang->harga, 0, ',', '.') }}</span>
                        </div>
                        <div class="flex justify-between border-t pt-3">
                            <span class="font-semibold">Total yang harus dibayar:</span>
                            <span class="font-semibold text-green-600 text-lg" id="total-price">Rp
                                {{ number_format($formulir->gelombang->harga, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('pembayaran.store') }}" method="POST" id="paymentForm">
                    ...
                    <div class="mb-6">
                        <label for="promo_voucher_id" class="block text-sm font-medium text-gray-700 mb-2">Kode Promo
                            (Opsional)</label>
    ...
    @include('pembayaran.confirmation-modal')
@endsection