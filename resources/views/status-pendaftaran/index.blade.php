...
<div class="py-8">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6 text-center">
            <div class="mb-4">
                @if(isset($formulir->status) && $formulir->status === 'terverifikasi')
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <span class="ml-2">Rp {{ number_format($pembayaran->jumlah, 0, ',', '.') }}</span>
                </div>
                <div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <div class="flex flex-wrap gap-4">
                @if(!$pembayaran)
                <a href="{{ route('pembayaran.create') }}" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-200 font-medium">
                    <i class="fas fa-credit-card mr-2"></i>Bayar Sekarang
                </a>
                @elseif($pembayaran && $pembayaran->status === 'lunas')
                <a href="{{ route('status.cetak-pdf', $formulir->id) }}" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition duration-200 font-medium">
