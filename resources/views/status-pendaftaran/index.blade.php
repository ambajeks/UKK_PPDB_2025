                ...
                <div class="flex flex-wrap gap-4">
                    @if($revisiMenunggu)
                        <a href="{{ route('revisi.show') }}"
                            class="px-6 py-3 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition duration-200 font-medium inline-flex items-center">
                            <i class="fas fa-exclamation-circle mr-2 text-lg"></i>
                            <div class="text-left">
                                <div>Lengkapi Revisi</div>
                                <div class="text-xs opacity-90">Ada permintaan revisi dari admin</div>
                            </div>
                        </a>
                    @endif
